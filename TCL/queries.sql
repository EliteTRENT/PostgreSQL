Q1  insert into staff(employee_id,first_name,last_name,salary)values(10,'Aman','Deep',500);
    insert into staff(employee_id,first_name,last_name,salary)values(20,'Nauti','Antriksh',50);
